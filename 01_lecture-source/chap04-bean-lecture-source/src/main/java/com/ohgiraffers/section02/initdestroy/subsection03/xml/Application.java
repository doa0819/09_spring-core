...
//                new AnnotationConfigApplicationContext(ContextConfiguration.class);   -> xml 파일 이용해서 해서 ContextConfiguration.class 가 없어도 되서 해당 class 를 찾지 못해서 오류
...
//        ((AnnotationConfigApplicationContext)context).close();  // loc container 강제로 닫아줌
